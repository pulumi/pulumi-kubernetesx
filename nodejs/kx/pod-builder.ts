...
export type JobBuilderArgs = {
    ...
    // The max time the CronJob can run before being terminated.
...
export class PodBuilder extends pulumi.ComponentResource {
    ...
    public createJob(
        ...
        const jobBuilder = makeJobBuilderBase(jobArgs, this.podBuilder);
    ...
    public createCronJob(
        ...
        const cronJobBuilder = makeCronJobBuilderBase(cronJobArgs, this.podBuilder);
    ...
    public createDeployment(
        ...
        const deployBuilder = makeDeploymentBuilderBase(deploymentArgs, this.podBuilder);
    ...
    public createReplicaSet(
        ...
        const replicaSetBuilder = makeReplicaSetBuilderBase(replicaSetArgs, this.podBuilder);
    ...
    public createDaemonSet(
        ...
        const daemonSetBuilder = makeDaemonSetBuilderBase(daemonSetArgs, this.podBuilder);
...
export function makeDeploymentBuilderBase(
    ...
    return {
        ...
        spec: {
            replicas: utils.objOrDefault(deploymentArgs.replicas, 1),
...
export function makeReplicaSetBuilderBase(
    ...
    return {
        ...
        spec: {
            replicas: utils.objOrDefault(replicaSetArgs.replicas, 1),
            selector: { matchLabels: pb.metadata.labels },
            template: {
                metadata: pulumi.output(pb.metadata),
                spec: pulumi.output(pb.spec),
